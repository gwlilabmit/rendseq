...
def bowtie_to_peak(align_file, thresh=12, peak_file=None):
    ...
    peak_file:
        (optional, default = None), str path to a peaks file. If
    ...
    """
    wig_prefix = bowtie_to_wig(align_file, peak_file=peak_file)
